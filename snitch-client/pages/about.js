...
function About() {
    ...
    <div className="row" style={{ backgroundColor: "gray" }}>
      ...
      <div className="col-sm-6">
        <image src="https://pilbox.themuse.com/image.jpg?filter=antialias&h=384&opt=1&pos=top-left&prog=1&q=keep&url=https%3A%2F%2Fcms-assets.themuse.com%2Fmedia%2Flead%2Fquestions-to-ask-05202022-602012447-Thomas-Barwick.jpg%3Fv%3Ded8d97d1eee7834c77adc5d87afe41247a8b2473&w=767"
        alt="Holding image"
        width="70px"
        height="70px" />
